namespace ClothingRentalManagement.Client.Static
{
    public static class Endpoints
    {
        ...
        public static string SizesEndpoint = $"{Prefix}/sizes";
        public static string WearersEndpoint = $"{Prefix}/wearers";
        public static string WearingsEndpoint = $"{Prefix}/wearings";
